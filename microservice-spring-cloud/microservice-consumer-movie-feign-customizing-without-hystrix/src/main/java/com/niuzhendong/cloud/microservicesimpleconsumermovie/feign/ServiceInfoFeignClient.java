 ...
 * @date 2019/12/6
 */
@FeignClient(name = "xxx",url = "http://localhost:8761/",configuration = BasicAuthRequestInterceptorConfiguration.class,fallback = ServiceInfoFeignClientFallBack.class)
